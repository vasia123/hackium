import { Hackium } from '..';
import { ArgumentsWithDefaults } from '../arguments';
...
export declare type PuppeteerLaunchOptions = LaunchOptions & BrowserLaunchArgumentOptions & PuppeteerNodeLaunchOptions;
